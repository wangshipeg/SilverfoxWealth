...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _minimumSize = CGSizeMake(100.0f, 1.0f);
...
- (void)updateHUDFrame {
    ...
    CGFloat verticalSpacing = 5.0f; // |-12-content-(8-label-)12-|
    CGFloat horizontalSpacing = 10.0f; // |-12-content-12-|
...
#pragma clang diagnostic pop
    ...
    self.hudView.bounds = CGRectMake(-3.0f, 0.0f, MAX(self.minimumSize.width, hudWidth) + 6, MAX(self.minimumSize.height, hudHeight));
...
- (UIColor*)backgroundColorForStyle {
    if(self.defaultStyle == SVProgressHUDStyleLight) {
        ...
        return [UIColor colorWithRed:203 green:203 blue:203 alpha:1];
    } else {
