...
- (UIPageControl *)pageControl {
    if (!_pageControl) {
        ...
        _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(Width / 2 - width / 2, CGRectGetHeight(self.scrollView.frame) - 30, width, 10)];
        _pageControl.numberOfPages = self.numberOfPages;
        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:156.0/255.0 green:156.0/255.0 blue:156.0/255.0 alpha:1.0];
        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:76.0/255.0 green:167.0/255.0 blue:238.0/255.0 alpha:1.0];
