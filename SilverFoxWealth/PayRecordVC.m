...
- (void)addIncomeRecordObserve {
    ...
    [center addObserver:self selector:@selector(addMessageNoteWith) name:@"PayLoadOver" object:nil];
}
...
- (void)achieveExchangeRecordDataWith:(NSString *)customerId {
    [[DataRequest sharedClient]requestExchageDetailWithCustomerId:customerId type:0 page:page history:0 mobile:1 startDate:nil endDate:nil callback:^(id obj) {
...
- (void)notHaveSilverClearList {
    ...
    [VCAppearManager arrengmentNotDataViewWithSuperView:_backContentView title:@"土豪，暂无支出记录哦!"];
