...
- (void)initCityPickerView{
    ...
    //一个工具栏
    UIView *viewTool=[[UIView alloc] initWithFrame:CGRectMake(0, KScreenHeight-216-40, KScreenWidth, 40)];
    UIColor *color=[UIColor backgroundGrayColor];
    ...
    [btnCancel setTitleColor:[UIColor iconBlueColor] forState:UIControlStateNormal];
    ...
    [btnSure setTitleColor:[UIColor iconBlueColor] forState:UIControlStateNormal];
