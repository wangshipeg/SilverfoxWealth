...
@interface IncomeRecordVC ()<UITableViewDelegate,UITableViewDataSource>
{
    int page;
}
...
- (void)addIncomeRecordObserve {
    ...
    [center addObserver:self selector:@selector(addMessageNoteWith) name:@"AllExchangeLoadOver" object:nil];
}
...
- (void)sendMessageToPayRecordDataRequest{
    ...
    [messageCenter postNotificationName:@"PayLoadOver" object:Nil userInfo:nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *silverIdentifier=@"incomeRecord";
...
- (void)notHaveSilverClearList {
    ...
    [VCAppearManager arrengmentNotDataViewWithSuperView:_backContentView title:@"土豪，暂无收入记录哦!"];
