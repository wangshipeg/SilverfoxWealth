...
@property (nonatomic, strong) UACircularProgressView *backView; //灰色的圈
...
- (void)sharedSetup {
    ...
    //放置灰色默认圆框
    _backView=[[UACircularProgressView alloc] initWithFrame:self.bounds];
    //填充色
    _backView.shapeLayer.fillColor=[UIColor clearColor].CGColor;
...
- (void)setBorderWidth:(CGFloat)borderWidth {
    ...
    self.backView.shapeLayer.borderWidth = borderWidth;
...
//    self.progressView.shapeLayer.borderColor = tintColor.CGColor;
    ...
    self.backView.shapeLayer.borderColor=[UIColor colorWithRed:209/255.f green:209/255.f blue:209/255.f alpha:1].CGColor;
}
...
- (UIBezierPath *)layoutPath {
    ...
    return [UIBezierPath bezierPathWithArcCenter:CGPointMake(width/2.0f, width/2.0f)
                                          radius:width/2.0f - borderWidth/2
