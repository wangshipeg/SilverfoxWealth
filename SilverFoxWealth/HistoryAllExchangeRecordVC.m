...
@interface HistoryAllExchangeRecordVC ()<UITableViewDelegate,UITableViewDataSource>
{
    int page;
}
...
@implementation HistoryAllExchangeRecordVC
...
- (void)sendMessageToIncomeRecordDataRequest{
    ...
    [messageCenter postNotificationName:@"HistoryAllExchangeLoadOver" object:Nil userInfo:nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *silverIdentifier=@"HistoryExchangeRecord";
...
- (void)notHaveSilverClearList {
    ...
    [VCAppearManager arrengmentNotDataViewWithSuperView:_backContentView title:@"土豪，没有交易记录哦!"];
