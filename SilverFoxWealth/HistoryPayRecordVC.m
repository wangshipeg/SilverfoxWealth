...
@interface HistoryPayRecordVC ()<UITableViewDelegate,UITableViewDataSource>
{
    int page;
}
...
@implementation HistoryPayRecordVC
...
- (void)addIncomeRecordObserve {
    ...
    [center addObserver:self selector:@selector(addMessageNoteWith) name:@"HistoryPayLoadOver" object:nil];
}
...
- (void)achieveExchangeRecordDataWith:(NSString *)customerId {
    [[DataRequest sharedClient]requestExchageDetailWithCustomerId:customerId type:0 page:page history:1 mobile:1 startDate:nil endDate:nil callback:^(id obj) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *silverIdentifier=@"payRecord";
...
- (void)notHaveSilverClearList {
    ...
    [VCAppearManager arrengmentNotDataViewWithSuperView:_backContentView title:@"土豪，没有支出记录哦!"];
